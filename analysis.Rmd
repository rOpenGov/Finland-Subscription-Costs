...
#f = f = "http://avaa.tdata.fi/documents/kuhiti/Kustantajahintatiedot_Koko_Aineisto.csv"
...
df = rename(df, Type = Way.of.acquisition)
```
...
fees on scientific publishing in 2010-2015. The average annual costs for in Finland were `r round(mean((df %>% group_by(Year) %>% summarise(Costs = sum(Cost)/1e6))$Costs))` MEUR in 2010-2015.
